...
export default function Receipt() {
  ...
  if (!txData) {
    return (
      <div className="min-h-screen bg-[#faf6f6] flex items-center justify-center p-6 text-center">
        <div>
          <p className="text-gray-500 mb-4">No transaction data found.</p>
          <button onClick={() => navigate('/')} className="bg-[#bf4a53] text-white px-8 py-3 rounded-full font-bold shadow-lg">
            Return Home
          </button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen font-sans bg-[#faf6f6]">
      ...
      <div className={`fixed left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-md rounded-full px-6 py-3 flex items-center gap-3 shadow-2xl z-[1000] transition-all duration-500 ${showToast ? 'top-10' : '-top-20'}`}>
        ...
        <span className="font-bold text-sm text-[#111010]">SMS Confirmation Sent!</span>
      </div>

      {/* --- MOBILE UI (Hidden on md and up) --- */}
      <div className="flex md:hidden flex-col h-screen overflow-hidden">
        ...
        <div className="flex-grow overflow-y-auto px-6 pt-4 pb-48">
        ...
        <div className="fixed bottom-0 left-0 right-0 p-6 pb-10 bg-white rounded-t-[36px] shadow-[0_-8px_24px_rgba(0,0,0,0.07)] flex flex-col gap-3">
          <button onClick={handleSendSMS} className="w-full bg-[#bf4a53] text-white py-4.5 rounded-[22px] font-extrabold text-[16px] flex items-center justify-center gap-3 active:scale-[0.96] transition-all">
          ...
          <button onClick={() => window.print()} className="w-full bg-[#111010] text-white py-4.5 rounded-[22px] font-extrabold text-[16px] flex items-center justify-center gap-3">
      ...
      <div className="hidden md:flex h-screen w-full bg-white overflow-hidden">
        {/* Left Branding Panel */}
        <div className="w-[40%] bg-gradient-to-br from-[#ff6b76] to-[#bf4a53] p-16 flex flex-col justify-between text-white relative">
        ...
        {/* Right Invoice Panel */}
        <div className="w-[60%] flex flex-col bg-[#faf6f6] p-16 lg:p-24 overflow-y-auto">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-3xl font-black text-gray-900">Summary Details</h2>
            <button onClick={() => navigate('/')} className="text-gray-400 hover:text-[#bf4a53] transition-colors p-2 font-bold text-sm uppercase tracking-widest">
              Close Dashboard
            </button>
          </div>
          ...
          <div className="space-y-8 max-w-2xl">
            {/* Item Detail Card */}
            <div className="bg-white p-8 rounded-[32px] shadow-sm flex items-center gap-8 border border-gray-100">
              ...
              <div className="grow">
                <p className="text-xs font-black text-[#bf4a53] uppercase tracking-widest mb-1">Rented Item</p>
            ...
            {/* Financial Breakdown */}
            <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 divide-y divide-gray-50">
              ...
              <div className="pt-8 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-5xl font-black text-[#bf4a53]">₱{txData.baseRate + txData.deposit}</p>
                </div>
            ...
            <div className="flex gap-4 pt-4">
              <button onClick={handleSendSMS} className="flex-1 bg-[#bf4a53] text-white py-5 rounded-2xl font-bold shadow-xl shadow-[#bf4a53]/20 hover:brightness-110 active:scale-95 transition-all">
                Send SMS Receipt
              </button>
...
function TicketCard({ txData }) {
  return (
    <div className="relative bg-white rounded-[32px] p-7 shadow-lg">
      <div className="absolute left-[-15px] top-[53%] -translate-y-1/2 w-[30px] h-[30px] bg-[#faf6f6] rounded-full z-10"></div>
      <div className="absolute right-[-15px] top-[53%] -translate-y-1/2 w-[30px] h-[30px] bg-[#faf6f6] rounded-full z-10"></div>
      
      <div className="text-center mb-6">
        <h2 className="text-[24px] font-extrabold text-[#bf4a53]">RentBook</h2>
      ...
      <div className="space-y-4 mb-6">
        ...
        <Drow label="Return" value="Mar 07, 2026" color="#bf4a53" />
      </div>

      <div className="border-t-2 border-dashed border-gray-100 my-6"></div>

      <div className="flex items-center gap-4 bg-[#faf6f6] p-3 rounded-[18px] mb-4">
        <div className="grow">
          <p className="text-[15px] font-extrabold text-[#111010]">{txData.item}</p>
      ...
      <div className="flex justify-between items-center mt-6">
        <span className="text-[17px] font-bold text-[#111010]">Total Paid</span>
        <span className="text-[30px] font-black text-[#bf4a53]">₱{txData.baseRate + txData.deposit}</span>
      </div>
