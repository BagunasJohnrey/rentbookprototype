...
export default function AdminBottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white h-[85px] rounded-t-[24px] flex justify-between items-center px-4 pb-4 shadow-[0_-10px_40px_rgba(0,0,0,0.08)] z-50 border-t border-gray-100">
